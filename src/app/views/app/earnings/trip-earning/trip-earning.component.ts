...
import { TripEarningDetailsModalComponent } from 'src/app/containers/pages/trip-earning-details-modal/trip-earning-details-modal.component';
...
@Component({
  selector: 'app-trip-earning',
  templateUrl: './trip-earning.component.html',
  styleUrls: ['./trip-earning.component.scss']
})
export class TripEarningComponent implements OnInit {
  itemsPerPage = 20;
  itemOptionsPerPage = [];
  ...
  @ViewChild('addNewModalRef', { static: true }) addNewModalRef: TripEarningDetailsModalComponent;
  ...
  getTripEarningList() {
    ...
    this.earingService.fetchTripEarning(json).then(res => {
